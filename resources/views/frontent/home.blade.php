			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img src="{{asset('category/'.$category->image)}}" width="256px" height="256px" alt="">
							</div>
							<div class="shop-body">
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												...
												<img src="{{asset('category/'.$images)}}" width="256px" height="256px" >
						...
						<div class="row">
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <a href="{{url('details'.$topProduct->id)}}">
                                            <img src="{{asset('category/'.$images)}}" width="256px" height="256px" >
                                            <div class="product-label">
                                                <span class="sale">-30%</span>
                                                <span class="new">NEW</span>
