    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                ...
                <h2><i class="halflings-icon cat"></i><span class="break"></span>Brand</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{$brand->id}}</td>
                        <td class="center" style="width: 20%">{{$brand->name}}</td>
                        <td class="center" style="width: 20%">{{$brand->description}}</td>
                        <td class="center">
                            @if($brand->status==1)
